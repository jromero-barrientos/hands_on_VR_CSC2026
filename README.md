# Variance Reduction Hands-On (CERN Computing School 2026)
...
### 🏃🏽‍♀️ 4. Run the notebooks (in order)
...
> ‼️ **Important:** Do not change the provided build/run helper cells unless explicitly asked in the notebook instructions.
