...
GB02ActionInitialization::~GB02ActionInitialization() = default;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void GB02ActionInitialization::BuildForMaster() const
{
  SetUserAction(new GB02RunAction());
}
...
void GB02ActionInitialization::Build() const
{
  ...
  auto* runAction = new GB02RunAction();
  SetUserAction(runAction);

  auto* eventAction = new GB02EventAction(runAction);
  SetUserAction(eventAction);

  SetUserAction(new GB02SteppingAction(eventAction));
}
