...
class B01Run : public G4Run
{
  ...
  public:
    ...
    G4THitsMap<G4double>* GetHitsMapSq(G4int i) { return fRunMapSq[i]; }
    G4THitsMap<G4double>* GetHitsMap(const G4String& detName, const G4String& colName);
    G4THitsMap<G4double>* GetHitsMapSq(const G4String& detName, const G4String& colName);
    G4THitsMap<G4double>* GetHitsMap(const G4String& fullName);
    G4THitsMap<G4double>* GetHitsMapSq(const G4String& fullName);
  ...
  private:
    ...
    std::vector<G4THitsMap<G4double>*> fRunMapSq;
